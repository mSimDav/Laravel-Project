...
echo "<br>";
?>
                                                                    <a href="<?php echo '/Lara7/public/logout' ;?>" class="button icon solid fa-arrow-circle-right">Logout</a>
                                                                    <a href="<?php echo '/Lara7/public/showall' ;?>" class="button icon fa-file-alt">Change database</a>
                                                                </div>
